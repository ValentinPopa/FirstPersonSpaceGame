...
public class CollectableSpawner : MonoBehaviour
{
    ...
    public Collectable ActiveInstance;
    ...
    private IEnumerator DrawpathToCollectable()
    {
        ...
        while(ActiveInstance!=null) 
        {
            ...
            {
                Debug.LogError($"Unable to calculate a path to the NavMesh between {Player.position} and {ActiveInstance.transform.position}!");
            }
            yield return Wait;
        }
    }
